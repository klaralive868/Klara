...
{#if href}
	<!-- href is a caller-supplied, data-driven prop on this generic primitive; Standards §6 accepts the resulting lint warning rather than forcing resolve() on a path the resolver can't type-check -->
